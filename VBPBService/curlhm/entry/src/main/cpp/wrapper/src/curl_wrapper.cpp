...
class CurlClient {
  ...
  public:
    void StartRequest(CurlRequest request, CurlCallback *callback) {
        ...
        logI(log_tag_, "ret code:" + std::to_string(errorCode) + ", errorMsg:" + curl_error_msg_ 
            + ",ip:" + ip + ", dataLen:" + std::to_string(content_data_.length()) + ", redirect url:" + redirect_url_ + "\nheader:\n" + headers_);
        logD(log_tag_, "data:\n" + content_data_);
  ...
  private:
    ...
    void HandleElapseStatisticsInfo(CurlResponse *curlResponse) {
        ...
        logD(log_tag_, "request statistics, nameLookupTime:" + std::to_string(nameLookupTime) + ", connectTime:" + std::to_string(connectTime)
            + ", sslCostTime:" + std::to_string(sslCostTime) + ", preTransferTime:" + std::to_string(preTransferTime)
            + ", startTransferTime:" + std::to_string(startTransferTime) + ", redirectTime:" + std::to_string(redirectTime)
            + ", recvTime:" + std::to_string(totalTime - startTransferTime) + ", totalTime:" + std::to_string(totalTime));
        ...
        curlResponse->elapse.recvTime = totalTime - startTransferTime;
