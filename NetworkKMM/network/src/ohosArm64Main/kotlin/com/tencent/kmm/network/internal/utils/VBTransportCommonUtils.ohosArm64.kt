...
actual suspend fun readUnknownSize(channel: ByteReadChannelWrapper): ByteArray = ByteArray(0)

actual fun ByteArray.mergeFromChunks(chunks: List<ByteArray>) {
}

actual fun getHttpClient(kmmRequest: VBTransportBaseRequest): Any? = null